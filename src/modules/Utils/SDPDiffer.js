...
SDPDiffer.prototype.toJingle = function(modify, srcAdd, myJid) {
    ...
    Object.keys(sdpMediaSsrcs).forEach(function(mediaindex) {
        ...
        modify = modify.c('content', { name: media.mid });

        modify = modify.c('description', { xmlns: 'urn:xmpp:jingle:apps:rtp:1', media: media.mid });
        // FIXME: not completely sure this operates on blocks and / or handles
        // different ssrcs correctly
        // generate sources from lines
        Object.keys(media.ssrcs).forEach(function(ssrcNum) {
            var mediaSsrc = media.ssrcs[ssrcNum];
            modify = modify.c('source', { xmlns: 'urn:xmpp:jingle:apps:rtp:ssma:0' });
        ...
        media.ssrcGroups.forEach(function(ssrcGroup) {
            if (ssrcGroup.ssrcs.length) {
                ...
                modify = modify.up(); // end of ssrc-group
            }
        });

        modify = modify.up(); // end of description
        modify = modify.up(); // end of content
    });
